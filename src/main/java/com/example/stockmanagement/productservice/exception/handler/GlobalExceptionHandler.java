...
@RestControllerAdvice // Exception handlarımızı tek bir genel hata componentin de birleştirmemize olanak sağlar
    ...
    public InternalApiResponse<String> handleProductNotCreatedException(ProductNotCreatedException exception){
        ...
        return  InternalApiResponse.<String>builder()
                .friendlyMessage(FriendlyMessage.builder()
                        ...
                        .description(FriendlyMessageUtils.getFriendlyMessage(exception.getLanguage(), exception.getFrendlyMessageCode()))
                        .build())
